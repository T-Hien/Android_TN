...
public class PDFPoint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdfpoint);

        // Lấy danh sách dữ liệu từ CustomAdapterExam
        dataListFromAdapter = CustomAdapterExam.getDataList();

        btnTao = findViewById(R.id.btnTao); // Lấy tham chiếu đến button từ layout
        ...
        btnTao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String filePath = getExternalFilesDir(null).getPath() + "/example.pdf";
                exportToPDF(PDFPoint.this, dataListFromAdapter, filePath);
            }
        });
    }

    // Lớp PDFExporter nằm trong cùng tệp với lớp PDFPoint
            ...
            for (Object data : dataList) {
                if (data instanceof List) {
                    ...
                    String line = "Ma Mon: " + String.valueOf(((Double) innerDataList.get(0)).intValue()) + "\n"
                            ...
                            + "Nguoi Tao: " + String.valueOf(innerDataList.get(2)) + "\n"
                            + "Diem: " + String.valueOf(innerDataList.get(3)) + "\n\n";
